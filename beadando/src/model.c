...
void init_entities(World* world) {
	...
	// plant1
	load_model("models//coral.obj", &world->plant1.model);
	world->plant1.texture = load_texture("textures//green.jpg");
	init_plant(&world->plant1, 120, -60,0);
	

	// plant2
	load_model("models//coral2.obj", &world->plant2.model);
	world->plant2.texture = load_texture("textures//brown.jpg");
	init_plant(&world->plant2, -60, 120,0);
	
	// fish1
	load_model("models//fish.obj", &world->fish.model);
	world->fish.texture = load_texture("textures//fish.png");
	init_fish(&world->fish, -80, 140, 80);
	...
	world->room.top = load_texture("textures//wall.jpg");
